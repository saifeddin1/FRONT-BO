...
export class EditSeanceNiveauComponent {
  ...
  niveauDataSource: MatTableDataSource<Niveau> = new MatTableDataSource<Niveau>();
  ...
  assignNiveau(niveau: Niveau) {
    this.seanceNivService.create({ seanceId: this.seanceId, niveauId: niveau._id })
      .subscribe((res: SeanceNiv) => {
  ...
  dataSource: MatTableDataSource<SeanceNiv> = new MatTableDataSource<SeanceNiv>();
  displayedColumns: string[] = ['name', 'action'];
  getSeanceNiveaux() {
    this.seanceNivService.findBySeanceId(this.seanceId)
      .subscribe((res: SeanceNiv[]) => {
        console.log("res : ", res)
