...
import { MediaAssign, MediaAssignService } from '../../niveau/list-assign-media/mediaAssign.service';
...
export class ListSeanceAssignMediaComponent implements OnInit {
  ...
  getSeanceMedias() {
    this.mediaAssignService.findByAssignId(this.seanceId, undefined)
  ...
  goToFiles(mediaId) {
    this.router.navigate(['seances/edit/mediaAssignFile/list/', this.seanceId, mediaId]);
  }
}