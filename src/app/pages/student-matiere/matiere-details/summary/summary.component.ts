...
import { NiveauMatiere, NiveauService } from 'src/app/pages/admin/niveau/niveau.service';
import { Matiere } from 'src/app/pages/admin/matiere/matiere.service';
...
export class SummaryComponent implements OnInit {
  ...
  getSeeMoreMatiere(limit = 3) {
    this.niveauService.getSeeMoreByNiveauId(this.userService.user.studentNiveauId, this.nivMatId, limit)
      .subscribe((otherMatieresList: any) => {
